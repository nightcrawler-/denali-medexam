...
class WorkplacesTest < ApplicationSystemTestCase
  ...
  test "creating a Workplace" do
    ...
    fill_in "Address", with: @workplace.address
    fill_in "Email", with: @workplace.email
    fill_in "Location", with: @workplace.location
    fill_in "Name", with: @workplace.name
    fill_in "Phone", with: @workplace.phone
    fill_in "Registration", with: @workplace.registration
